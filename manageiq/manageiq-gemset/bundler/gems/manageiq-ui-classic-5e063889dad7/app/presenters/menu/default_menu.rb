module Menu
  class DefaultMenu
    class << self
	  ...
	  #security_and_identity_menu_section,
	  #monitor_menu,
          logout_item,
        ]
      end
      ...
      def relational_database_menu_section
        Menu::Section.new(:rdb, N_("Relational Databases"), nil, [
          Menu::Item.new('postgresql',     N_('PostgreSQL'),     'chargeback_reports',     {:feature => 'chargeback_reports_show_list', :any => true}, '/catalog/explorer'),
          Menu::Item.new('mysql',       N_('MYSQL'),       'chargeback_rates',       {:feature => 'chargeback_rates_show_list',   :any => true},'/catalog/explorer'),
          Menu::Item.new('mariadb', N_('MariaDB'), 'chargeback_assignments', {:feature => 'chargeback_assignments'},               '/catalog/explorer'),
	  Menu::Item.new('centos', N_('CentOS'), 'chargeback_assignments', {:feature => 'chargeback_assignments'},               '/catalog/explorer#/service_catalogs/centos'),
        ])
      end

      def big_data_menu_section
        Menu::Section.new(:bgd, N_("Big Data"), nil, [
          Menu::Item.new('apache_hadoop',     N_('Apache Hadoop'),     'chargeback_reports',     {:feature => 'chargeback_reports_show_list', :any => true}, '/catalog/explorer'),
          Menu::Item.new('hbase', N_('Hbase'),       'chargeback_rates',       {:feature => 'chargeback_rates_show_list',   :any => true}, '/catalog/explorer'),
          Menu::Item.new('hive', N_('Hive'), 'chargeback_assignments', {:feature => 'chargeback_assignments'},                     '/catalog/explorer'),
	  Menu::Item.new('kafka', N_('Kafka'), 'chargeback_assignments', {:feature => 'chargeback_assignments'},                     '/catalog/explorer'),
          Menu::Item.new('presto', N_('Presto'), 'chargeback_assignments', {:feature => 'chargeback_assignments'},                     '/catalog/explorer'),
          Menu::Item.new('apache_airflow', N_('Apache Airflow'), 'chargeback_assignments', {:feature => 'chargeback_assignments'},                     '/catalog/explorer'),
        ])
      end

      def vdi_menu_section
        Menu::Section.new(:vdi, N_("VDI"), nil, [
          Menu::Item.new('apache_guacamole',     N_('Apache Guacamole'),     'chargeback_reports',     {:feature => 'chargeback_reports_show_list', :any => true}, '/catalog/explorer'),
          Menu::Item.new('kasm_vdi',       N_('KASM VDI Service'),       'chargeback_rates',       {:feature => 'chargeback_rates_show_list',   :any => true}, '/catalog/explorer'),
        ])
      end

      def applications_menu_section
        Menu::Section.new(:as, N_("Applications"), nil, [
          Menu::Item.new('odoo',     N_('Odoo'),     'chargeback_reports',     {:feature => 'chargeback_reports_show_list', :any => true}, '/catalog/explorer'),
          Menu::Item.new('zammad',       N_('Zammad'),       'chargeback_rates',       {:feature => 'chargeback_rates_show_list',   :any => true}, '/catalog/explorer'),
          Menu::Item.new('wordpress', N_('Wordpress'), 'chargeback_assignments', {:feature => 'chargeback_assignments'},                     '/catalog/explorer'),
          Menu::Item.new('nextcloud', N_('Nextcloud'), 'chargeback_assignments', {:feature => 'chargeback_assignments'},                     '/catalog/explorer'),
        ])
      end

      def email_and_groupware_menu_section
        Menu::Section.new(:eag, N_("Email and Groupware"), nil, [
          Menu::Item.new('mailcow',     N_('Mailcow'),     'chargeback_reports',     {:feature => 'chargeback_reports_show_list', :any => true}, '/catalog/explorer'),
          Menu::Item.new('sogo',       N_('Sogo Service'),       'chargeback_rates',       {:feature => 'chargeback_rates_show_list',   :any => true}, '/catalog/explorer'),
        ])
      end

      def webconferencing_and_collaboration
        Menu::Section.new(:wcac, N_("Web Conferencing and Collaboration"), nil, [
          Menu::Item.new('jitsi',     N_('Jitsi'),     'chargeback_reports',     {:feature => 'chargeback_reports_show_list', :any => true}, '/catalog/explorer'),
          Menu::Item.new('rocket_chat',       N_('Rockerchat Service'),       'chargeback_rates',       {:feature => 'chargeback_rates_show_list',   :any => true}, '/catalog/explorer'),
        ])
      end
      ...
      def services_menu_section
        Menu::Section.new(:svc, N_("Services"), 'carbon--ToolBox', [
			    ...
			    #relational_database_menu_section,
			    #big_data_menu_section,
			    #vdi_menu_section,
			    #applications_menu_section,
			    #email_and_groupware_menu_section,
			    #webconferencing_and_collaboration,
                          ])
      end
      ...
      def observability_menu_section
        Menu::Section.new(:ob, N_("Observability"), 'carbon--IbmSecurity', [
          help_grafana_service,
	])
      end
      ...
      def monitor_menu
         Menu::Section.new(:mm, N_("Monitor"), 'carbon--Activity', [ 
	  help_cu_monitoring,
	])
      end
     ...
     def help_cu_monitoring
          help_menu_item(:cu_monitoring, :title => N_('C&U Monitoring'),
                                         :href  => 'http://xaasio.com/' )
     end

     def help_grafana_service
          help_menu_item(:grafana_service, :title => N_('Grafana Service'),
                                         :href  => 'http://192.168.210.14:3000/' )
     end
      ...
      def security_and_identity_menu_section
        Menu::Section.new(:si, N_("Security and Identity"), 'carbon--Settings', [
	  Menu::Item.new('support_tickets', N_('Support Tickets Menu'), 'my_settings', {:feature => 'my_settings', :any => true}, '/catalog/explorer'),
	])
      end
      ...
      def help_pdf
           #pdf_path = asset_path('pdf/sample.pdf') # this helper will generate the correct path for your asset
	   pdf_url = '/pdf/Xaas-IX-CMP.pdf'
           help_menu_item(:user_guide_pdf, :title => N_('User Guide'),:href  => pdf_url)
      end
