Rails.application.routes.draw do
  ...
  # rubocop:enable Layout/MultilineOperationIndentatio
  get 'pdf' => 'dashboard#pdf'

  #get 'pre_prov', to: 'miq_request#pre_prov', as: :pre_prov
  #post 'miq_request/pre_prov', to: 'miq_request#pre_prov'  
  # config/routes.rb
  #namespace :miq_request do
   #get 'pre_prov', on: :collection
  #end
